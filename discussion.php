...
<body>
    <header></header>
    <main>
        <h3>Parler Basket avec une commu qui est la pour ça c'est mieux, n'est ce pas <?php echo $_SESSION['login']; ?>?</h3>
        <table>
            <thead>
                <tr>
                    <th>Posteurs</th>
            ...
            <?php
                ...
                foreach ($info_com as $com => $infos)
                {
                    ...
                    {
            ?>
                        <a href="discussion.php?id=<?php echo $infos['id']; ?>"><img src="https://img.icons8.com/cotton/64/000000/delete-message.png"></a>          
            <?php
        ...
        ?>
                <form action="discussion.php" method="POST">
                    ...
                    <button type="submit" name="envoyer">Shoot</button>
                </form>
        <?php
        ...
        ?>
            <form action="discussion.php" method="POST">
                <button type="submit" name="deco">Déco</button>
            </form>
    </main>
    <footer></footer>
</body>
